...
function Account() {
  ...
  return (
    <View style={styles.container}>
     ...
     <View>
      <Image source={{uri:"https://images.pexels.com/photos/6973960/pexels-photo-6973960.jpeg?auto=compress&cs=tinysrgb&w=400"}}style={styles.accountProfile}/>
     ...
     <FlatList
      ...
      <View style={styles.accountMenu}>
       <View style={styles.imageDiv}> <Image source={item.icon}  style={styles.imageIcon}/></View>
